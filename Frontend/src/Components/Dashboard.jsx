...
function Dashboard() {
    ...
    const handleLogout = () => {
        axios.get('https://admin-and-users.vercel.app/auth/logout')
        .then(result =>{
            ...
            <div className='row flex-nowrap'>
                <div className='col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark'>
                    <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100'>
                        <Link to="/dashboard" className='d-flex align-items-center pb-3 mb-md-1 mt-md-3 me-md-auto text-white text-decoration-none'>
                            <img src="./Images/logohy.png" className=' img-fluid logo_py' alt="" />
                            {/* <span className='fs-5 fw-bolder d-none d-sm-inline'>Hyperverge</span> */}
                        </Link>
                ...
                <div className='col p-0 m-0'>
                    <div className='p-2 d-flex justify-content-center shadow'>
                        <h4 className='users'>Users Management</h4>
                    </div>
                    <Outlet />
                </div>
            </div>

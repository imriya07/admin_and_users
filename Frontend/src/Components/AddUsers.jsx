...
function AddUsers() {
    ...
    return (
        <div className='d-flex justify-content-center align-items-center mt-3 userlist'>
            <div className='p-3 rounded w-50 border'>
                <h2 className='text-center add_user'>Add Users</h2>
                <form className='row g-1' onSubmit={handleSubmit}>
                    ...
                    <div className='col-12'>
                        ...
                        <input type="tel" name='phone' onChange={(e) => setUsers({...users, phone: e.target.value})} className='form-control rounded-0' id='inputPhone' placeholder='Enter Phone' /> */}
                    </div>
                    {/* <div className='col-12'>
                        <label htmlFor="inputPhone" className='form-label'>Phone</label>
                        <input type="tel" onChange={(e) => setUsers({...users, phone: e.target.value})} className='form-control rounded-0' id='inputPhone' placeholder='Enter Phone' />
                    </div> */}
                    <div className='col-12'>
                    ...
                    <div className='col-12 mb-3'>
                        <button type='submit' className='btn btn-success w-100'>Add Users</button>
                    </div>
                </form>
            </div>
        </div>
